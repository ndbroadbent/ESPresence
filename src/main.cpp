...
void setupNetwork() {
...
#ifdef VERSION
    AsyncWiFiSettings.info("ESPresence Version: " + String(VERSION));
#endif
    ...
    AsyncWiFiSettings.hostname = "espresence-" + kebabify(room);
...
void onMqttConnect(bool sessionPresent) {
    ...
    mqttClient.subscribe("espresence/rooms/*/+/set", 1);
